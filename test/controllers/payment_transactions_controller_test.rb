...
class PaymentTransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_transaction" do
    assert_difference('PaymentTransaction.count') do
      post payment_transactions_url, params: { payment_transaction: { credit: @payment_transaction.credit, debit: @payment_transaction.debit, notes: @payment_transaction.notes } }
    end
  ...
  test "should update payment_transaction" do
    patch payment_transaction_url(@payment_transaction), params: { payment_transaction: { credit: @payment_transaction.credit, debit: @payment_transaction.debit, notes: @payment_transaction.notes } }
