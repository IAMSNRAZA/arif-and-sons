...
**************************************************
01. Basic Column Chart JS
02. Column with Data Labels JS
03. Stacked Columns JS
04. Stacked Columns 100 JS
05. Column with Negative Values JS
06. Dynamic Loaded Column Chart JS
*/
...
$(document).on('turbolinks:load', function () {
    ...
    /* 05. Column with Negative Values
    -------------------------------------------------*/
    var options = {
        chart: {
            height: 360,
    ...
    /* 06. Dynamic Loaded Column Chart
    -------------------------------------------------*/
    Apex = {
        chart: {
            toolbar: {
